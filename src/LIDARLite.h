...
class LIDARLite
{
  public:
      LIDARLite();
      bool begin(int = 0, bool = false, char = LIDARLITE_ADDR_DEFAULT);
      bool configure(int = 0, char = LIDARLITE_ADDR_DEFAULT);
      bool setI2Caddr(char, char, char = LIDARLITE_ADDR_DEFAULT);
      bool reset(char = LIDARLITE_ADDR_DEFAULT);
      int distance(bool = true, char = LIDARLITE_ADDR_DEFAULT);
      bool write(char, char, char = LIDARLITE_ADDR_DEFAULT);
